...
dir = input("You're in the top of a hill, do you want to go left or right?\n")
if dir == "left":
    dir = input("You fell down into a cave, but somehow you survived\ndo you want to swim the lake or go to the dark path?\n")
    if dir == "swim":
        dir = input("You find a river of aligators\nbut somehow you managed to pass through them\nand arrives in a three way split.\nDo you go, left, right or middle?\n")
